<?php 
    // Have the function ThirdGreatest(strArr) take
    // the array of strings stored in strArr and return the third largest
    // word within in. So for example: if strArr is ["hello", "world", "before", "all"] your output should be world because "before" is 6
    ...
    function ThirdGreatest($strArr)
    {
        ...
        return print_r($strArr[2], true);
    }

    $strArr = ["hello", "world", "before", "all"]; // world
    // $strArr = ["hello", "world", "before", "all", "Roberto"]; // hello
    // $strArr = ["hello", "world", "after", "all"]; // after
    echo ThirdGreatest($strArr);